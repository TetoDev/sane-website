...
class Game:
    ...
    def __init__(self, name: str, recommended_cpus: str, recommended_gpus: str, recommended_ram: int, storage: int,
                 img_url: str):
        self.name = name

        self.requirements = {
            "cpu": recommended_cpus,
            "graphicCards": recommended_gpus,
            "ram": recommended_ram,
        }
...
warzone2 = Game("Call of Duty: Modern Warfare II", "AMD Ryzen R5 1600X processor", "Nvidia GeForce GTX 1660 6GB", 12,
                175, "")
